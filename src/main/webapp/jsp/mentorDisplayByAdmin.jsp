...
<body>
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="/createSkillPage">Add Skills<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/viewMentors">View Mentors</a>
      </li>
      <li class="nav-item">
	...
	<%
		List mentorList = (List) request.getAttribute("allMentorList");
	...
	<div style="overflow-x: auto;">
		<table>
			...
			<tr>
				...
				<td><%=m.getTimeslot()%></td>
				<% if( m.getAccess()==1){ %>
				<td><a href="/block?mentorId=<%=m.getMentorId()%>">Block</td>
				<%} else { %>
				<td><a href="/block?mentorId=<%=m.getMentorId()%>">Unblock</td>
				<%} %>
				<%
					if (session.getAttribute("adminName") != null) {
				%>
