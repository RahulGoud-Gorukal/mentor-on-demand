<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.util.*,com.example.MentorOnDemand.Model.Mentor,com.example.MentorOnDemand.Model.Skill"%>
...
<ul>
	...
	<div class="container register-form">
		<form:form method="GET" action="/registerAdmin"
			modelAttribute="registerAdmin">
			<div class="note">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<b>Enter Admin Name</b>
							<form:input type="text" class="form-control" path="adminName"
								id="adminName" placeholder="Admin Name *" />
							<form:errors path="adminName" class="errorColor" />
						</div>
						<div class="form-group">
							<b>Gender</b>
							<br>
